...
import { getNtAccessToken, NT_BASE } from "@/lib/ntApi";
...
export function TerminalViewer({
  ...
  const [fontSize, setFontSize] = useState<number>(() =>
    parseInt(localStorage.getItem("cheeseFont") || "14", 10),
  );
  ...
  useEffect(() => {
    ...
    function wsUrl(): string {
      ...
      const url = new URL(
        `${NT_BASE}/machine/screen/${encodeURIComponent(sid)}`,
