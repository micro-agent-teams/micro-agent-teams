 ...
 *               Its cheeselet is resources/cheeselets/claude.js.
 *
 *  Author(s):
...
class ClaudeDriver : AgentDriver {
    ...
    override val cheeseletSource: String by lazy {
        ClassPathResource("cheeselets/claude.js").inputStream.bufferedReader().use { it.readText() }
    }
