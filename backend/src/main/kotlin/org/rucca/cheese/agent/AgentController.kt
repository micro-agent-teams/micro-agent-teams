 ...
 *               generated from MAT-API.yml, nothing more. Opening and closing an agent, the one
...
import org.rucca.cheese.agent.screen.AgentService
import org.rucca.cheese.agent.screen.ScreenAgent
import org.rucca.cheese.api.AgentApi
...
import org.rucca.cheese.chat.thread.ThreadMemberRepository
...
import org.rucca.cheese.team.membership.TeamService
import org.rucca.cheese.user.RolePermissionService
...
class AgentController(
    ...
    override fun postNote(postNoteRequestDTO: PostNoteRequestDTO): ResponseEntity<MessageDTO> {
        ...
        val screenToken = request.getHeader("X-Cheese-Screen")
