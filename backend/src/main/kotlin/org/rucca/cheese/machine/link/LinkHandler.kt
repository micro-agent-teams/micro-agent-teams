 ...
 *               The frozen CLI dials `ws(s)://<base>/agent` with an `X-Cheese-Session:
...
class LinkHandler(private val hub: MachineHub, private val objectMapper: ObjectMapper) :
    ...
    private companion object {
        // 4 MB: comfortably above the cheeselet source and any single terminal chunk.
    ...
    override fun afterConnectionEstablished(session: WebSocketSession) {
        ...
        // Screen frames carry the full cheeselet source (session.create) and base64
